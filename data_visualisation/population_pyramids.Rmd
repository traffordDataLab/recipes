...
<a href="https://github.com/trafforddatalab/recipes/edit/master/data_visualisation/population_pyramids.Rmd" class="btn btn-default"><i class="fa fa-edit"></i> Edit this page</a>

<h1>Population pyramids</h1>
...
<p><a href="https://www.nomisweb.co.uk/query/construct/summary.asp?mode=construct&version=0&dataset=2002" target="_blank">Nomis, ONS</a></p>
<br />
</div>
...
<div class = "col-md-4">
<img src="img/population_pyramid.png" alt="Population pyramid">
</div>
</div>
...
2. Visit <a href="https://www.nomisweb.co.uk/query/construct/summary.asp?mode=construct&version=0&dataset=2002" target="_blank">Nomis</a> and select your chosen Geography, Date, Age and Sex. Here we've chosen every single year of age (Age) and Male and Female (Sex).

3. Navigate to 'Format / Layout' and choose 'Nomis API' as your format. Hit the 'Download Data' button. Select the 'Tabulation links' tab and right-click the 'Comma Separated Values (csv)' file to obtain the URL path. 
...
5. Prepare the data for visualisation. Here we group the individual years into age bands and calculate the corresponding population by gender.
```{r, eval=FALSE}
population <- df %>% 
...
ggplot(population, aes(x = ageband, y = n, fill = gender)) +
  ...
  coord_flip() +
  labs(x = NULL, y = NULL, 
       title = "Age composition of Trafford in mid-2017",
