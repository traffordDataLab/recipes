...
2. Visit <a href="https://www.nomisweb.co.uk/query/construct/summary.asp?mode=construct&version=0&dataset=2002" target="_blank">Nomis</a> and select your chosen **Geography**, **Date**, **Age** and **Sex**. Here we've chosen Trafford (**Geography**), 2017 (**Date**), individual ages (**Age**) and both genders (**Sex**).
...
ggplot() +
  ...
  geom_line(data = filter(population, area_name == "England"), 
            aes(x = ageband, y = percent, group = gender, colour = gender), stat = "identity",
            size = 1) +
  scale_fill_manual(values = c("#7FC5DC", "#7FDCC5"), labels = c("Female", "Male")) +
  ...
  coord_flip() +
  labs(x = NULL, y = "%", 
       title = "Age composition of Trafford compared with England in mid-2017",
       caption = "Source: Office for National Statistics", 
       fill = NULL) +
  theme_minimal() +
  theme(plot.margin = unit(c(1,1,1,1), "cm"),
